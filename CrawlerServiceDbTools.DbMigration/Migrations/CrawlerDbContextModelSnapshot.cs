...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrawlerServiceRoot.Domain.SchemeModels.SchemeModel", b =>
                {
            ...
            modelBuilder.Entity("CrawlerServiceRoot.Domain.TaskModels.TaskModel", b =>
                {
            ...
            modelBuilder.Entity("CrawlerServiceRoot.Domain.TaskStartPoints.TaskStartPoint", b =>
                {
            ...
            modelBuilder.Entity("CrawlerServiceRoot.Domain.TermsByUrls.TermByUrl", b =>
                {
            ...
            modelBuilder.Entity("CrawlerServiceRoot.Domain.BatchParts.BatchPart", b =>
                {
                    b.HasOne("CrawlerServiceRoot.Domain.Batches.Batch", "BatchNavigation")
                        .WithMany("BatchParts")
            ...
            modelBuilder.Entity("CrawlerServiceRoot.Domain.ContentsAnalysis.ContentAnalysis", b =>
                {
                    b.HasOne("CrawlerServiceRoot.Domain.BatchParts.BatchPart", "BatchPartNavigation")
                        .WithMany("ContentsAnalysis")
                        .HasForeignKey("BatchPartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CrawlerServiceRoot.Domain.UrlModels.UrlModel", "UrlNavigation")
                        .WithMany("ContentsAnalysis")
                        .HasForeignKey("UrlId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CrawlerServiceRoot.Domain.HostsByBatches.HostByBatch", b =>
                {
                    ...
                    b.HasOne("CrawlerServiceRoot.Domain.HostModels.HostModel", "HostNavigation")
                        .WithMany("HostsByBatches")
                        .HasForeignKey("HostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CrawlerServiceRoot.Domain.SchemeModels.SchemeModel", "SchemeNavigation")
                        .WithMany("HostsByBatches")
            ...
            modelBuilder.Entity("CrawlerServiceRoot.Domain.TaskStartPoints.TaskStartPoint", b =>
                {
                    b.HasOne("CrawlerServiceRoot.Domain.TaskModels.TaskModel", "TaskNavigation")
            ...
            modelBuilder.Entity("CrawlerServiceRoot.Domain.Terms.Term", b =>
                {
                    b.HasOne("CrawlerServiceRoot.Domain.TermTypes.TermType", "TermTypeNavigation")
                        .WithMany("Terms")
            ...
            modelBuilder.Entity("CrawlerServiceRoot.Domain.TermsByUrls.TermByUrl", b =>
                {
                    ...
                    b.HasOne("CrawlerServiceRoot.Domain.Terms.Term", "TermNavigation")
                        .WithMany("TermsByUrls")
            ...
            modelBuilder.Entity("CrawlerServiceRoot.Domain.UrlGraphNodes.UrlGraphNode", b =>
                {
                    ...
                    b.HasOne("CrawlerServiceRoot.Domain.UrlModels.UrlModel", "FromUrlNavigation")
                        .WithMany("UrlGraphNodesFrom")
                        .HasForeignKey("FromUrlId")
                        .IsRequired();

                    b.HasOne("CrawlerServiceRoot.Domain.UrlModels.UrlModel", "GotUrlNavigation")
            ...
            modelBuilder.Entity("CrawlerServiceRoot.Domain.UrlModels.UrlModel", b =>
                {
                    b.HasOne("CrawlerServiceRoot.Domain.ExtensionModels.ExtensionModel", "ExtensionNavigation")
                        .WithMany("Urls")
